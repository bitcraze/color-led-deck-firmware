##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.2.0-B44] date: [Mon Apr 07 16:30:07 CEST 2025] 
##########################################################################################################################
...
flash:
	$(OPENOCD) -d2 -f $(OPENOCD_INTERFACE) $(OPENOCD_CMDS) -f $(OPENOCD_TARGET) -c init -c targets -c "reset halt" \
                 -c "flash write_image erase build/$(TARGET).bin 0x8000000 bin" \
                 -c "verify_image build/$(TARGET).bin 0x8000000 bin" -c "reset run" -c shutdown
