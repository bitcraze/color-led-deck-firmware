...
// }
  ...
  // Test number to activate each color
  ...
  while (1)
  {
    ...
    // TIM1->CCR3 = botLedR; //Red
    // TIM1->CCR4 = botLedG;  //Green
    // Rev.B
    // TIM1->CCR1 = botLedW; //White
    // TIM1->CCR2 = botLedG; //Green
    // TIM1->CCR3 = botLedR; //Red
    // TIM1->CCR4 = botLedB; //Blue
    
      // Rev.D
    // if (botLedG || botLedR || botLedB || botLedW)
    // {
    //   // Enable bottom LED (has priority). 
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : ADDR_SELECT_Pin */
